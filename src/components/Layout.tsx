                   ...
                   {activeView === 'account' && (
                     <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:gap-4">
                           <div className="bg-slate-50 p-4 sm:p-5 rounded-[2rem] border border-slate-100 shadow-sm">
                              <span className="text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-2">Status Keanggotaan</span>
                              <div className="flex items-center gap-1.5">
                                 <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></div>
                                 <span className="text-[10px] sm:text-xs font-black text-emerald-600 uppercase tracking-tight">PENDAKI AKTIF</span>
                              </div>
                           </div>
                           <div className="bg-slate-50 p-4 sm:p-5 rounded-[2rem] border border-slate-100 shadow-sm">
                              <span className="text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1.5">ID Pengguna</span>
                              <span className="text-[10px] sm:text-xs font-black text-slate-800 uppercase tracking-widest">#{user.id.toUpperCase()}</span>
                           </div>
                        </div>
